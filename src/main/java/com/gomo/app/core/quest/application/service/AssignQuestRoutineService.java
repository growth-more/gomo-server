...
/**
 * This service creates {@link AssignQuest} entities for each participant.
...
@Transactional
@ApplicationService
class AssignQuestRoutineService implements AssignQuestRoutineCreator {
	...
	@Override
	@AuditLog(action = "ASSIGN_QUEST_ROUTINE_CREATE")
