...
public enum InterestErrorCode {
	...
	INTEREST_QUOTA_EXCEEDED("Exceeded the maximum number of allowed interests", 422),
	TOTAL_SCORE_TOO_LARGE("The given total score exceeds the allowable range", 422),
	TOTAL_SCORE_NEGATIVE("Proficiency adjustment failed total score cannot be negative", 422),
