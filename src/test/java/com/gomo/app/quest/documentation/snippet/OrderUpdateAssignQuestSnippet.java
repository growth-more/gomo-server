...
public class OrderUpdateAssignQuestSnippet {
	...
	private static final String IDENTIFIER = "order_update_assign_quest";
	private static final String SUMMARY = "할당 퀘스트 정렬 순서 변경 API";
	private static final String DESCRIPTION = "할당 퀘스트 목록의 정렬 순서를 변경합니다.";
	...
	public static RestDocumentationFilter create() {
		return document(
			...
			ResourceSnippetParameters.builder()
				...
				.tag(TAG)
				.requestSchema(Schema.schema("OrderUpdateAssignQuestRequest")),
			REQUEST_FIELDS
		);
	}
