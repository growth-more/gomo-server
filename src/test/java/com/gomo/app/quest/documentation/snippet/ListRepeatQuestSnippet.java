...
public class ListRepeatQuestSnippet {
	...
	private static final Snippet RESPONSE_FIELDS = responseFields(
		fieldWithPath("dailyQuests").type(JsonFieldType.ARRAY).description("일간 반복 퀘스트 목록"),
		...
		fieldWithPath("weeklyQuests").type(JsonFieldType.ARRAY).description("주간 반복 퀘스트 목록"),
		fieldWithPath("weeklyQuests[].id").type(JsonFieldType.STRING).description("반복 퀘스트 아이디"),
		...
		fieldWithPath("monthlyQuests").type(JsonFieldType.ARRAY).description("월간 반복 퀘스트 목록"),
		fieldWithPath("monthlyQuests[].id").type(JsonFieldType.STRING).description("반복 퀘스트 아이디"),
