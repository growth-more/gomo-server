 ...
 */
@Component
public class JavaInterestFixture {

	private static final String ID = "f8c51811-d7c5-11ef-82dc-4322ccc3e338";
	private static final String REGISTRANT_ID = "a10581ce-d721-11ef-a8a5-2508e2a6438b";
	private static final int LEVEL = 6;
	private static final int SCORE = 30;
	private static final int TOTAL_SCORE = 2430;
	private static final String NAME = "Java";
	private static final String LOGO_URL = "https://mini-cloud/java-logo.png";

	public static Interest java() {
		return new Interest(
