...
public class InterestDeleteServiceTest {
	...
	@InjectMocks
	private InterestDeleteService sut;
	...
	void delete_interest() {
		...
		doReturn(List.of(InterestRelationFixture.create())).when(interestRelationService).readAllByInterestId(any(UUID.class));
	...
	void delete_major_interest_relation() {
		...
		doReturn(interest).when(interestService).readById(any());
		doReturn(interestRelations).when(interestRelationService).readAllByInterestId(any(UUID.class));
	...
	void does_not_delete_major_interest_relation() {
		Interest interest = InterestFixture.create();
		doReturn(interest).when(interestService).readById(any());
		doReturn(List.of()).when(interestRelationService).readAllByInterestId(any(UUID.class));
