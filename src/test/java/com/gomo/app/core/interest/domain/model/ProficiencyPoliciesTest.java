...
class ProficiencyPoliciesTest {
	...
	void calculate_proficiency_with_zero_total_score() {
		...
		ProficiencyPolicies proficiencyPolicies = ProficiencyPolicies.from(levelThresholdPolicies);

		Proficiency actual = proficiencyPolicies.calculateProficiency(0);
	...
	void calculate_proficiency_with_total_score() {
		...
		Proficiency actual = proficiencyPolicies.calculateProficiency(5);
	...
	void calculate_proficiency_at_level_boundary() {
		...
		Proficiency actual = proficiencyPolicies.calculateProficiency(10);
	...
	void calculate_proficiency_in_level_interval() {
		...
		Proficiency actual = proficiencyPolicies.calculateProficiency(31);
	...
	void calculate_proficiency_at_highest_level() {
		...
		Proficiency actual = proficiencyPolicies.calculateProficiency(100);
	...
	void calculate_proficiency_with_negative_total_score() {
		ProficiencyPolicies proficiencyPolicies = ProficiencyPolicies.from(List.of());
		assertThatThrownBy(() -> proficiencyPolicies.calculateProficiency(-1)).isInstanceOf(ProficiencyAdjustFailureException.class);
	}
	...
	void initialize_policies() {
		ProficiencyPolicies proficiencyPolicies = ProficiencyPolicies.from(List.of());
		assertThatThrownBy(() -> proficiencyPolicies.calculateProficiency(10)).isInstanceOf(IllegalStateException.class);
	}
}
