...
public class RegistrantTest {
	...
	void not_exceed_interest_quota() {
		Registrant registrant = Registrant.of(UUID.randomUUID(), InterestQuota.FREE.name());
	...
	@Test
	void free_to_free() {
		Registrant registrant = Registrant.of(UUID.randomUUID(), "FREE");
	...
	@Test
	void basic_to_basic() {
		Registrant registrant = Registrant.of(UUID.randomUUID(), "BASIC");
	...
	void premium_to_premium() {
		Registrant registrant = Registrant.of(UUID.randomUUID(), "PREMIUM");
