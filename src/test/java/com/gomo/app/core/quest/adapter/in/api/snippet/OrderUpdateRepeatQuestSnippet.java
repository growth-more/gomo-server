...
public class OrderUpdateRepeatQuestSnippet {
	...
	private static final String IDENTIFIER = "quest-repeat-order-update";
	...
	private static final Snippet REQUEST_FIELDS = requestFields(
		...
		fieldWithPath("updatedOrders[].orderChangeableId").type(JsonFieldType.STRING).description("변경 대상 반복 퀘스트 아이디"),
